...
---
# <a name="use-powershell-toocreate-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>Use o PowerShell toocreate um único banco de dados do SQL Azure e configurar uma regra de firewall

Este exemplo de script do PowerShell cria um banco de dados SQL do Azure e configura uma regra de firewall no nível do servidor. Depois que o script hello foi executado com êxito, Olá que banco de dados SQL podem ser acessado de todos os serviços do Azure e hello endereço IP configurado. 
