...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Use o PowerShell toosync entre vários bancos de dados do SQL Azure
 
Este exemplo do PowerShell configura toosync de sincronização de dados entre vários bancos de dados do SQL Azure.
