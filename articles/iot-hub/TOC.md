...
#### Use Olá IoT Gateway Starter Kit
##### [Configurar a NUC Intel como um gateway](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
##### [Conecte-se Olá gateway tooIoT Hub](iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
##### [Usar gateway Olá para conversão de dados](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
...
### [Salvar mensagens de IoT Hub tooAzure armazenamento de dados](iot-hub-store-data-in-azure-table-storage.md)
...
# Como
## Plano
### [Comparação de IoT Hub tooEvent Hubs](iot-hub-compare-event-hubs.md)
...
##### [Enviar mensagens de dispositivo para nuvem tooIoT Hub](iot-hub-devguide-messages-d2c.md)
##### [Ler mensagens de dispositivo para a nuvem de ponto de extremidade internos Olá](iot-hub-devguide-messages-read-builtin.md)
...
#### [Controlar acesso tooIoT Hub](iot-hub-devguide-security.md)
...
### [Usar o dispositivo IoT de saudação SDK para C](iot-hub-device-sdk-c-intro.md)
#### [Use Olá IoTHubClient](iot-hub-device-sdk-c-iothubclient.md)
#### [Use o serializador Olá](iot-hub-device-sdk-c-serializer.md)
...
### Como toouse macros propriedades
...
### Use o firmware do dispositivo do dispositivo trabalhos tooupdate
...
## Gerenciar
### Crie um hub IoT 
#### [Usar o portal de saudação](iot-hub-create-through-portal.md)
...
#### [Use Olá API REST](iot-hub-rm-rest.md)
...
#### [Usar o portal de saudação](iot-hub-configure-file-upload.md)
...
## Segurança
### [Segurança de saudação de plano de fundo para cima](iot-hub-security-ground-up.md)
