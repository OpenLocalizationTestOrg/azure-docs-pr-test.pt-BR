...
> [!NOTE]
> Você pode usar a chave SSH, em vez do nome de usuário e senha ao se conectar ao Raspberry Pi. Para fazer isso, você precisará gerar a chave usando **ssh-keygen** e **pi ssh-copy-id @\<endereço do dispositivo\>**.
>
