...
1. Certifique-se de que você está na pasta do repositório de saudação `iot-hub-c-edison-getting-started`. Abra o aplicativo de exemplo hello no código do Visual Studio executando Olá comandos a seguir:
