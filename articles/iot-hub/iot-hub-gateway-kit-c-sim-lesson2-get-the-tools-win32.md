...
Se você tiver problemas com a instalação do hello, consulte Olá [guia de solução de problemas](iot-hub-gateway-kit-c-sim-troubleshooting.md) para problemas de toocommon de soluções.
