...
Antes de iniciar esse processo, você deve foi concluído com êxito [executar o aplicativo de exemplo hello intermitência do Azure em framboesa Pi 3](iot-hub-raspberry-pi-kit-node-lesson3-run-azure-blink.md).
...
[Executar mensagens de nuvem para dispositivo tooreceive do aplicativo de exemplo de hello](iot-hub-raspberry-pi-kit-node-lesson4-send-cloud-to-device-messages.md)
