---
title: trabalhos aaaSubmit Hadoop em HDInsight | Microsoft Docs
description: Saiba como toosubmit Hadoop trabalhos tooAzure HDInsight Hadoop.
editor: cgronlun
manager: jhubbard
services: hdinsight
documentationcenter: 
...
- Usar o SDK do .NET
  ...
  - [Executar trabalhos de Pig usando Olá SDK .NET para Hadoop no HDInsight](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
- PowerShell
  ...
  - [Usar Sqoop com o Hadoop no HDInsight](hdinsight-hadoop-use-sqoop-powershell.md)
  - [Executar trabalhos MapReduce com Hadoop no HDInsight usando o PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
