...
#### [Use Olá exibição Hive](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Usar as ferramentas do HDInsight Olá para Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Usar Área de Trabalho Remota](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Saudação de usar o Console de consulta](hdinsight-hadoop-use-hive-query-console.md)
...
### [Executar exemplos de MapReduce Olá](hdinsight-hadoop-run-samples-linux.md)
...
#### [Use Olá SDK .NET](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Repositório de Lake tooData gravação](hdinsight-storm-write-data-lake-store.md)
...
### [Use as ferramentas do HDInsight toocreate Spark aplicativos](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Usar ferramentas do HDInsight toodebug Spark aplicativos remotamente por meio do SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Conecte-se usando Olá Hive JDBC driver](hdinsight-connect-hive-jdbc-driver.md)
...
### [Conecte-se a rede de local de tooyour HDInsight](connect-on-premises-network.md)
...
#### [Usar REST tooinstall aplicativos](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publicar aplicativos de HDInsight tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Segurança
### [Use o SSH com o HDInsight](hdinsight-hadoop-linux-use-ssh-unix.md)
### [Usar túnel SSH](hdinsight-linux-ambari-ssh-tunnel.md)
### [Restringir acesso toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Gerenciar
...
#### [Use ondulação e Olá API REST do Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Use Olá SDK .NET](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Use Olá CLI do Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Use Olá portal do Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Use Olá CLI do Azure](hdinsight-administer-use-command-line.md)
### [Gerenciar clusters usando a interface da web Ambari Olá](hdinsight-hadoop-manage-ambari.md)
...
### [Migrar as ferramentas de desenvolvimento do Gerenciador de tooResource](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Disponibilidade e confiabilidade](hdinsight-high-availability-linux.md)
### [Atualizar versão de toonewer de cluster do HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Usar exibições do Ambari toodebug Tez trabalhos](hdinsight-debug-ambari-tez-view.md)
...
# Relacionados
## Clusters do Windows
### [Migração de clusters do Windows clusters tooLinux](hdinsight-migrate-from-windows-to-linux.md)
### [Migrar .NET soluções tooLinux clusters](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Use Giraph tooprocess em larga escala gráficos](hdinsight-hadoop-giraph-install.md)
...
### [Usar aplicativos de Java toobuild Maven](hdinsight-hbase-build-java-maven.md)
### [Use Olá Tez UI toodebug Tez trabalhos](hdinsight-debug-tez-ui.md)
...
### [Monitorar clusters usando Olá Ambari API](hdinsight-monitor-use-ambari-api.md)

# Recursos
## [Roteiro do Azure](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Obter ajuda no fórum Olá](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
