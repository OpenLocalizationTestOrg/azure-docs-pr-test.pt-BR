...
Para saber mais sobre como configurar as extensões de diagnóstico para os serviços de nuvem do Azure, consulte [habilitar o diagnóstico nos serviços de nuvem do Azure usando o PowerShell][Enable diagnostics in Azure Cloud Services using PowerShell]
