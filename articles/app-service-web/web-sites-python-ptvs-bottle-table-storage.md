...
2. Os modelos de projeto das [VSIX de amostra de Ferramentas Python 2.2 para Visual Studio] estão disponíveis em **Python**, **Amostras**. Selecione **Projeto Web Bottle de Votações** e clique em OK para criar o projeto.
...
2. Clique no ícone **Novo** no canto superior esquerdo do Portal. Em seguida, clique em **Dados + Armazenamento** > **Conta de Armazenamento**.  Clique no botão **Criar** e, em seguida, forneça um nome exclusivo à conta de armazenamento e crie um novo [grupo de recursos](../azure-resource-manager/resource-group-overview.md) para ela.
