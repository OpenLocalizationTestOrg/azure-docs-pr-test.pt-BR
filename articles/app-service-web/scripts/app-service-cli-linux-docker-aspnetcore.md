...
Nesse cenário, você aprenderá como toocreate um grupo de recursos, o aplicativo Linux plano e o aplicativo web de serviço e implantar um aplicativo do ASP.NET Core usando um contêiner do Docker.
