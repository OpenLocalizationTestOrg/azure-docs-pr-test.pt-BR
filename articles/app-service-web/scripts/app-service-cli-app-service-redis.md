...
---
# <a name="connect-a-web-app-tooa-redis-cache"></a>Conecte-se a um cache de redis de tooa de aplicativo web

Nesse cenário, você aprenderá como toocreate um Azure redis cache e um aplicativo web do Azure. Em seguida, você vinculará aplicativo hello redis cache toohello web usando configurações do aplicativo.
...
Esse script usa Olá comandos toocreate um grupo de recursos, o aplicativo web, redis cache e relacionados com todos os recursos a seguir. Cada comando na documentação específica do toocommand Olá tabela links.
...
| [az redis create](https://docs.microsoft.com/en-us/cli/azure/redis#create) | Crie uma nova instância do Cache Redis. Isso é onde os dados de saudação serão armazenados. |
| [az redis list-keys](https://docs.microsoft.com/en-us/cli/azure/redis#list-keys) | Lista as chaves de acesso de saudação da instância de cache redis hello. |
