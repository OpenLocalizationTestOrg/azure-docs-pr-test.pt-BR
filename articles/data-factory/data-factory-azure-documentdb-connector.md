...
1. **Pergunta:** a atividade de cópia dá suporte à atualização de registros existentes?
    ...
    **Resposta:** Não.
2. **Pergunta:** como faz uma nova tentativa de uma cópia de banco de dados do Azure Cosmos para tratar já copiados registros?
...
3. **Pergunta:** dá suporte a fábrica de dados [intervalo ou o particionamento de dados com base em hash](../documentdb/documentdb-partition-data.md)?

    **Resposta:** Não.
4. **Pergunta:** posso especificar mais de uma coleção de banco de dados do Azure Cosmos para uma tabela?
