...
Você pode conectar tooSQL Data Warehouse com vários protocolos de aplicativo diferente como [ADO.NET][ADO.NET], [ODBC][ODBC], [PHP] [ PHP] e [JDBC][JDBC]. A seguir estão alguns exemplos de cadeias de conexão para cada protocolo.  Você também pode usar a cadeia de conexão Olá toobuild portal do Azure.  toobuild sua cadeia de caracteres de conexão usando Olá portal do Azure, navegue tooyour folha do banco de dados, em *Essentials* clique em *Mostrar cadeias de conexão de banco de dados*.
...
> [!NOTE]
> Considere a configuração Olá conexão tempo limite too300 segundos na ordem tooallow Olá conexão toosurvive curtos períodos de indisponibilidade.
> 
> 
