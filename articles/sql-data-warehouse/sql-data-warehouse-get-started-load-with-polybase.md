...
Este tutorial mostra como os dados de tooload no SQL Data Warehouse usando PolyBase e o AzCopy. Quando terminar, você saberá como:
...
Consulte também [guia de Introdução com hello o utilitário de linha de comando AzCopy][Getting Started with hello AzCopy Command-Line Utility].
