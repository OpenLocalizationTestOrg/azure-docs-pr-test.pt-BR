...
6. Na página **Tamanho** do assistente **Criar máquina virtual**, escolha o tamanho da máquina virtual.

    ![Criar VM — selecionar tamanho](./media/active-directory-domain-services-admin-guide/rhel-join-azure-portal-select-vm-size.png)

7. Na página **Configurações** do assistente **Criar máquina virtual**, escolha a conta de armazenamento para a máquina virtual. Clique em **Rede Virtual** para escolher a rede virtual na qual a VM do Linux deve ser implantada. Na folha **Rede Virtual**, escolha a rede virtual na qual o Azure AD Domain Services está disponível. Neste exemplo, vamos escolher a rede virtual 'MyPreviewVNet'.
...
8. Na página **Resumo** do assistente **Criar máquina virtual**, revise e clique no botão **OK**.
...
9. A implantação da nova máquina virtual com base na imagem do RHEL 7.2 deve começar.
...
10. Depois de alguns minutos, a máquina virtual deve estar implantada com êxito e pronta para uso.
...
**Conectar-se à máquina virtual do RHEL 7.2** siga as instruções no artigo [Como fazer logon em uma máquina virtual que executa o Linux](../virtual-machines/linux/mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
