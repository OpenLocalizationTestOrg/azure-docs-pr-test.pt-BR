...
### [Como toouse Cofre de chaves soft-delete com a CLI](key-vault-soft-delete-cli.md)
### [Como toouse Cofre de chaves soft-exclusão com o PowerShell](key-vault-soft-delete-powershell.md)
### [Use grupos toogrant acesso](key-vault-group-permissions-for-apps.md)
