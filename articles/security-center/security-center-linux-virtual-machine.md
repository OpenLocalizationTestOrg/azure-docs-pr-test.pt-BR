...
Se você clicar nesta recomendação, você verá mais detalhes sobre Olá ações específicas que devem ser tomadas tooaddress esses problemas. Olá detalhes serão exibidos na parte inferior da saudação da folha de saudação em **recomendações**. 
