...
---
# <a name="azure-cosmos-db-create-an-mongodb-api-account-using-hello-azure-cli"></a>Cosmos do Azure DB: Criar uma conta de API do MongoDB usando Olá CLI do Azure
