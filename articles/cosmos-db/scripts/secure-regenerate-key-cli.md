...
---
# <a name="regenerate-an-azure-cosmos-db-account-key-using-hello-azure-cli"></a>Regenerar uma chave de conta do banco de dados do Azure Cosmos usando Olá CLI do Azure

Este exemplo gera novamente a qualquer tipo de chave de conta de banco de dados do Azure Cosmos usando Olá CLI do Azure. 
