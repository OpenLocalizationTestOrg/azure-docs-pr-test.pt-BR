...
## [Sobre como mover circuitos do clássico tooResource Manager](expressroute-move.md)
...
## Vincular um circuito de rota expressa do tooan de rede virtual
...
## [Mover um circuito de clássico tooResource Manager](expressroute-howto-move-arm.md)
## [Migrar redes virtuais associadas de clássico tooResource Manager](expressroute-migration-classic-resource-manager.md)
...
### [Conecte-se a um circuito de tooa de gateway de rede virtual](https://azure.microsoft.com/documentation/videos/azure-expressroute-how-to-create-a-connection-between-your-vpn-gateway-and-expressroute-circuit/)
...
### [Como tooset o emparelhamento privado para o circuito](https://azure.microsoft.com/documentation/videos/azure-expressroute-how-to-set-up-azure-private-peering-for-your-expressroute-circuit/)
