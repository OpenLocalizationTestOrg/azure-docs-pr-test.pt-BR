...
## <a name="discover"></a>Descobrir
  Para procurar na Galeria de blocos de anotações, abra a [galeria](http://gallery.cortanaintelligence.com) e clique em **Notebooks** na parte superior da home page da Galeria.

 O  **[blocos de anotações do Jupyter](https://gallery.cortanaintelligence.com/notebooks)**  página exibe uma lista de blocos de anotações mais populares.
