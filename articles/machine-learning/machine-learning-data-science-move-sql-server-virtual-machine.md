...
Para um tópico que descreve as opções para movimentação de dados para um Banco de Dados SQL do Azure para Machine Learning, consulte [Mover dados para um banco de dados SQL do Azure para o Azure Machine Learning](machine-learning-data-science-move-sql-azure.md).
