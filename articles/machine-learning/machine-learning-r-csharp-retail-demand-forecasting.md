...
De dentro do Azure Machine Learning, um novo teste em branco foi criado. Os dados de entrada de amostra foram carregados com um esquema de dados predefinido. Há um módulo [Executar Script R][execute-r-script] vinculado ao esquema de dados, que gera modelos de previsão STL e ETS usando as funções “stl”, “ets” e “forecast” em R. 
