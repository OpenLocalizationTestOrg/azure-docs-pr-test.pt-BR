...
## [Use o AAD auth tooaccess API](media-services-use-aad-auth-to-access-ams-api.md)
### [Usar autenticação do AAD toomanage portal](media-services-portal-get-started-with-aad.md)
...
### [Use toocreate CLI e configure o aplicativo AAD](media-services-cli-create-and-configure-aad-app.md)
### [Use o PowerShell toocreate e configurar o aplicativo AAD](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Use MES tooauto-gerar uma escada de taxa de bits](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Como miniaturas toogenerate usando o codificador de mídia padrão com .NET](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Configurar a proteção de conteúdo no portal de saudação](media-services-portal-protect-content.md)
### [Configurar chave não criptografada AES-128 para sua transmissão](media-services-protect-with-aes128.md)
### [Usar o REST tooencrypt seu conteúdo com criptografia de armazenamento](media-services-rest-storage-encryption.md)
...
### [Usar parceiros toodeliver Widevine licenças de serviços de tooMedia](media-services-licenses-partner-integration.md)
#### [Usando Axinom toodeliver Widevine licenças tooMedia serviços](media-services-axinom-integration.md)
#### [Usando castLabs toodeliver Widevine licenças tooMedia serviços](media-services-castlabs-integration.md)
...
### [Analisar a mídia usando o portal de saudação](media-services-portal-analyze.md)
...
### [Inserir anúncios no lado do cliente Olá](media-services-inserting-ads-on-client-side.md)
