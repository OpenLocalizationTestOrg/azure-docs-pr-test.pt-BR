...
Este tópico discute as opções para entrega de ativos de mídia carregado tooMedia serviços. Você pode entregar conteúdo dos Serviços de Mídia em vários cenários de aplicativos. Você pode baixar ativos de mídia ou acessá-los usando um localizador. Você pode enviar o aplicativo de tooanother conteúdo de mídia ou tooanother provedor de conteúdo. Para melhor desempenho e escalabilidade, você também pode fornecer conteúdo usando uma CDN (Rede de Entrega de Conteúdo).

Este exemplo mostra como ativos de mídia toodownload do computador local do Media Services tooyour. consultas de código Olá Olá trabalhos associados à conta de serviços de mídia do hello, ID do trabalho e acessar seu **OutputMediaAssets** coleção (que é o conjunto de saudação de um ou mais ativos de mídia de saída que é o resultado da execução de um trabalho). Este exemplo mostra como mídia de saída toodownload ativos de um trabalho, mas você podem aplicar Olá mesmo toodownload de abordagem outros ativos.
