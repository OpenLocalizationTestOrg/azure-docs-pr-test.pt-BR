...
Este tópico descreve as etapas gerais que podem ser tomadas ao configurar a telemetria de serviços de mídia do Azure (AMS) hello usando a API REST. 
...
Olá etapas descritas neste tópico são:

- Obtendo a conta de armazenamento Olá associada com uma conta de serviços de mídia
- Obtendo pontos de extremidade de notificação Olá
- Criar um Ponto de extremidade de notificação para monitoramento. 

    toocreate um ponto de extremidade de notificação, defina Olá EndPointType tooAzureTable (2) e a tabela de armazenamento em toohello endPontAddress conjunto (por exemplo, https://telemetryvalidationstore.table.core.windows.net/).
  
- Obter configurações de monitoramento Olá
...
## <a name="get-hello-storage-account-associated-with-a-media-services-account"></a>Obter a conta de armazenamento Olá associada com uma conta de serviços de mídia
...
## <a name="get-hello-notification-endpoints"></a>Obter pontos de extremidade de notificação Olá
...
>[!NOTE]
>Não se esqueça de conta de armazenamento de tooyour toochange hello "https://telemetryvalidationstore.table.core.windows.net" valor.
...
## <a name="get-hello-monitoring-configurations"></a>Obter configurações de monitoramento Olá
