...
#### [TooVNet de rede virtual (VNet)](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
#### [Rede virtual (Gerenciador de recursos) tooa VNet (clássico)](../vpn-gateway/vpn-gateway-connect-different-deployment-models-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
#### [Rede de tooon local de rede virtual (VPN)](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
#### [Rede de tooon local de rede virtual (ExpressRoute)](../expressroute/expressroute-howto-linkvnet-portal-resource-manager.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
...
#### [Rede de Perímetro entre o Azure e saudação da Internet](../guidance/guidance-iaas-ra-secure-vnet-dmz.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
...
##### [Migrar de uma região de tooa do grupo de afinidade](virtual-networks-migrate-to-regional-vnet.md)
### Grupos de segurança de rede
...
### Máquinas virtuais
#### [Mover uma sub-rede diferente de tooa VM](virtual-networks-move-vm-role-to-subnet.md)
...
### [Problemas de conectividade de tooVM VM](virtual-network-troubleshoot-connectivity-problem-between-vms.md)
