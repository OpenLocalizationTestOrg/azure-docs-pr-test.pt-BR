...
Quando um aplicativo é registrado com o AD do Azure, o desenvolvedor do aplicativo hello registra informações relacionadas à Federação com o Azure AD. Isso inclui Olá **URI de redirecionamento** do aplicativo hello.
