...
Neste tutorial, você aprenderá como toointegrate Software Rally com o Azure Active Directory (AD do Azure).

Integração do Software Rally com o Azure AD oferece Olá benefícios a seguir:

- Você pode controlar no AD do Azure que tenha acesso tooRally Software.
- Você pode habilitar seu usuários tooautomatically get conectado tooRally Software (logon único) com suas contas do AD do Azure.
...
tooconfigure integração do AD do Azure com o Software Rally, você precisa Olá itens a seguir:
...
1. Adicionar Software Rally da Galeria de saudação
2. Configurar e testar o logon único do AD do Azure

## <a name="adding-rally-software-from-hello-gallery"></a>Adicionar Software Rally da Galeria de saudação
integração de saudação tooconfigure do Software Rally no AD do Azure, você precisa tooadd Rally Software na lista de tooyour Olá Galeria de aplicativos SaaS gerenciados.

**tooadd Software Rally da Galeria hello, execute Olá etapas a seguir:**
...
4. Na caixa de pesquisa hello, digite **Software Rally**, selecione **Software Rally** no painel de resultados e clique em **adicionar** botão aplicativo hello de tooadd.
...
Para toowork de logon único, o AD do Azure precisa tooknow que usuário de contraparte Olá no Rally Software é tooa usuário no AD do Azure. Em outras palavras, uma relação de link entre um usuário do AD do Azure e o usuário relacionado de saudação no Rally Software precisa toobe estabelecida.

No Software Rally, atribuir o valor de saudação do hello **nome de usuário** no AD do Azure como valor de saudação do hello **Username** tooestablish relação de link de saudação.

tooconfigure e teste de logon único do AD do Azure com o Rally Software, você precisa Olá toocomplete blocos de construção a seguir:
...
3. **[Criar um usuário de teste do Software Rally](#create-a-rally-software-test-user)**  -toohave um equivalente do Britta Simon no Rally Software que é vinculado toohello AD do Azure representação do usuário.
...
Nesta seção, habilitar o AD do Azure-logon único no hello portal do Azure e configurar o logon único em seu aplicativo de Software Rally.

**tooconfigure AD do Azure-logon único com o Software Rally, execute Olá etapas a seguir:**

1. Em Olá portal do Azure, Olá **Software Rally** página de integração de aplicativos, clique em **o logon único**.
...
3. Em Olá **Rally Software domínio e URLs** , execute Olá etapas a seguir:
    ...
    a. Em Olá **URL de logon** caixa de texto, digite um URL usando o saudação padrão a seguir:`https://<tenant-name>.rally.com`

    b. Em Olá **identificador** caixa de texto, digite um URL usando o saudação padrão a seguir:`https://<tenant-name>.rally.com`

    > [!NOTE] 
    > Esses valores não são reais. Atualizar esses valores com hello real URL de logon e o identificador. Entre em contato com [equipe de suporte do Rally Software cliente](https://help.rallydev.com/) tooget esses valores. 
...
6. Em Olá **configuração do Software Rally** seção, clique em **configurar Software Rally** tooopen **configurar o logon** janela. Saudação de cópia **URL de logout e a ID da entidade SAML** de saudação **seção de referência rápida.**

    ![Configuração do Rally Software](./media/active-directory-saas-rally-software-tutorial/tutorial_rallysoftware_configure.png) 

7. Faça logon no tooyour **Software Rally** locatário.

8. Na barra de ferramentas de saudação na parte superior do hello, clique em **instalação**e, em seguida, selecione **assinatura**.
   
    ![Assinatura](./media/active-directory-saas-rally-software-tutorial/ic769531.png "Assinatura")

9. Clique em Olá **ação** botão. Selecione **Editar assinatura** Olá superior direita da barra de ferramentas de saudação.

10. Em Olá **assinatura** página de diálogo Executar Olá etapas a seguir e, em seguida, clique em **Salvar & Fechar**:
    ...
    c. Em Olá **logoff SSO** caixa de texto valor Olá colar **URL de logout**, que você copiou do portal do Azure.
...
Para o AD do Azure usuários toobe capaz de toosign no, eles devem ser provisionado toohello aplicativo de Software Rally usando seus nomes de usuário do Active Directory do Azure.

**tooconfigure provisionamento de usuário, execute Olá etapas a seguir:**

1. Faça logon no tooyour locatário do Software Rally.

2. Vá muito**instalação \> usuários**e, em seguida, clique em **+ adicionar novo**.
   
    ![Usuários](./media/active-directory-saas-rally-software-tutorial/ic781039.png "Usuários")

3. Digite o nome de saudação na caixa de texto Olá novo usuário e, em seguida, clique em **adicionar detalhes**.
...
4. Em Olá **Create User** , execute Olá etapas a seguir:
    ...
    a. Em Olá **nome de usuário** caixa de texto Nome do tipo saudação do usuário como **Brittsimon**.
   
    b. Em **endereço de email** caixa de texto, insira o email de saudação do usuário como  **brittasimon@contoso.com** .

    c. Em **nome** texto, digite o nome saudação do usuário como **Britta**.

    d. Em **Sobrenome** texto, digite o sobrenome de saudação do usuário como **Simon**.

    e. Clique em **Salvar e Fechar**.

   >[!NOTE]
   >Você pode usar qualquer ferramenta de criação outros Software Rally usuário conta ou APIs fornecidas pelo Software Rally tooprovision contas de usuário do AD do Azure.

### <a name="assign-hello-azure-ad-test-user"></a>Atribuir um usuário de teste de saudação do AD do Azure

Nesta seção, você pode habilitar Britta Simon toouse logon único do Azure, concedendo acesso tooRally Software.

![Atribuir função de usuário Olá][200] 

**tooassign Britta Simon tooRally Software, executar Olá etapas a seguir:**

1. No hello portal do Azure, abra a exibição dos aplicativos Olá e navegue toohello exibição de diretório e ir muito**aplicativos empresariais** , em seguida, clique em **todos os aplicativos**.

    ![Atribuir usuário][201] 

2. Na lista de aplicativos hello, selecione **Software Rally**.
...
Quando você clica em um bloco de Software Rally Olá Olá painel de acesso, você deve obter tooyour automaticamente conectado no aplicativo de Software Rally.
