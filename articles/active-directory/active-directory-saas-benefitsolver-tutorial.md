...
1. No Portal clássico do Azure, na página de integração do aplicativo **Benefitsolver**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
2. Sobre o * * Benefitsolver * * página de integração de aplicativos, clique em **atribuir usuários**.
