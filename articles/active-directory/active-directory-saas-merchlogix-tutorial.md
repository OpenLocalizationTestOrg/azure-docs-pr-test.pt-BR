...
Neste tutorial, você aprenderá como toointegrate Merchlogix com o Azure Active Directory (AD do Azure).

Integrando Merchlogix com o AD do Azure fornece Olá benefícios a seguir:

- Você pode controlar no AD do Azure que tenha acesso tooMerchlogix.
- Você pode habilitar seu usuários tooautomatically get conectado tooMerchlogix (logon único) com suas contas do AD do Azure.
...
tooconfigure integração do AD do Azure com Merchlogix, você precisa Olá itens a seguir:
...
1. Adicionando Merchlogix da Galeria de saudação
2. Configurar e testar o logon único do AD do Azure

## <a name="adding-merchlogix-from-hello-gallery"></a>Adicionando Merchlogix da Galeria de saudação
integração de saudação tooconfigure de Merchlogix no AD do Azure, você precisa tooadd Merchlogix da lista de tooyour Olá Galeria de aplicativos SaaS gerenciados.

**tooadd Merchlogix da Galeria hello, execute Olá etapas a seguir:**
...
4. Na caixa de pesquisa hello, digite **Merchlogix**, selecione **Merchlogix** no painel de resultados e clique em **adicionar** botão aplicativo hello de tooadd.
...
Para toowork de logon único, o AD do Azure precisa tooknow que usuário de contraparte Olá em Merchlogix é tooa usuário no AD do Azure. Em outras palavras, uma relação de link entre um usuário do AD do Azure e o usuário relacionado de saudação em Merchlogix precisa toobe estabelecida.

Merchlogix, atribuir valor Olá Olá **nome de usuário** no AD do Azure como valor de saudação do hello **Username** tooestablish relação de link de saudação.

tooconfigure e teste de logon único do AD do Azure com Merchlogix, é necessário Olá toocomplete blocos de construção a seguir:
...
3. **[Criar um usuário de teste Merchlogix](#create-a-merchlogix-test-user)**  -toohave um equivalente do Britta Simon em Merchlogix é toohello vinculado do Azure AD representação do usuário.
...
Nesta seção, habilitar o AD do Azure-logon único no hello portal do Azure e configurar o logon único no aplicativo Merchlogix.

**tooconfigure AD do Azure-logon único com Merchlogix, execute Olá etapas a seguir:**

1. Em Olá portal do Azure, Olá **Merchlogix** página de integração de aplicativos, clique em **o logon único**.
...
3. Em Olá **Merchlogix domínio e URLs** , execute Olá etapas a seguir:
    ...
    a. Em Olá **URL de logon** caixa de texto, digite um URL usando o saudação padrão a seguir:`https://<DOMAIN>/login.php?saml=true`

    b. Em Olá **identificador** caixa de texto, digite um URL usando o saudação padrão a seguir:`https://<DOMAIN>/simplesaml/module.php/saml/sp/metadata.php/<SAML_NAME>`
    
    > [!NOTE]
    > Esses valores não são reais. Atualizar esses valores com hello real URL de logon e o identificador. Entre em contato com [Merchlogix a equipe de suporte](http://www.merchlogix.com/contact/) tooget esses valores.
...
6. Em Olá **Merchlogix configuração** seção, clique em **configurar Merchlogix** tooopen **configurar o logon** janela. Saudação de cópia **URL de logout, ID de entidade de SAML,** e **Single Sign-On URL do serviço SAML** de saudação **seção de referência rápida.**

    ![Configuração do Merchlogix](./media/active-directory-saas-merchlogix-tutorial/tutorial_merchlogix_configure.png) 

7. tooconfigure logon único no **Merchlogix** lado, você precisa toosend Olá baixado **certificado (Base64)**, **URL de logout, ID de entidade de SAML e SAML Single Sign-On URL do serviço** muito[a equipe de suporte Merchlogix](http://www.merchlogix.com/contact/). Eles definidos Olá de toohave essa configuração conexão SSO do SAML definido corretamente em ambos os lados.
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Merchlogix. Trabalhar com [Merchlogix a equipe de suporte](http://www.merchlogix.com/contact/) tooadd usuários de saudação na plataforma de Merchlogix hello.

### <a name="assign-hello-azure-ad-test-user"></a>Atribuir um usuário de teste de saudação do AD do Azure

Nesta seção, você pode habilitar Britta Simon toouse logon único do Azure, concedendo acesso tooMerchlogix.

![Atribuir função de usuário Olá][200] 

**tooassign Britta Simon tooMerchlogix, execute Olá etapas a seguir:**

1. No hello portal do Azure, abra a exibição dos aplicativos Olá e navegue toohello exibição de diretório e ir muito**aplicativos empresariais** , em seguida, clique em **todos os aplicativos**.

    ![Atribuir usuário][201] 

2. Na lista de aplicativos hello, selecione **Merchlogix**.
...
Quando você clica em bloco Merchlogix Olá Olá painel de acesso, você deve obter automaticamente assinado em tooyour Merchlogix aplicativo.
