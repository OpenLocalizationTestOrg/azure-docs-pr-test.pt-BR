...
Neste tutorial, você aprenderá como toointegrate unir com o Azure Active Directory (AD do Azure).

Integrando fusível AD do Azure fornece Olá benefícios a seguir:

- Você pode controlar no AD do Azure que tenha acesso tooFuse.
- Você pode habilitar seu usuários tooautomatically get conectado tooFuse (logon único) com suas contas do AD do Azure.
...
integração de tooconfigure AD do Azure com fusível, você precisa Olá itens a seguir:
...
1. Adicionar fusível da Galeria de saudação
2. Configurar e testar logon único do Azure AD

## <a name="add-fuse-from-hello-gallery"></a>Adicionar fusível da Galeria de saudação
integração de saudação tooconfigure do fusível no AD do Azure, você precisa tooadd fusível da lista de tooyour Olá Galeria de aplicativos SaaS gerenciados.

**tooadd fusível da Galeria hello, execute Olá etapas a seguir:**
...
4. Na caixa de pesquisa hello, digite **fusível**, selecione **fusível** no painel de resultados e clique em **adicionar** botão aplicativo hello de tooadd.
...
Para toowork de logon único, o AD do Azure precisa tooknow que usuário de contraparte Olá em fusível é tooa usuário no AD do Azure. Em outras palavras, uma relação de link entre um usuário do AD do Azure e o usuário relacionado de saudação em fusível necessidades toobe estabelecida.

Fusível, atribuir valor Olá Olá **nome de usuário** no AD do Azure como valor de saudação do hello **Username** tooestablish relação de link de saudação.

tooconfigure e teste de logon único do AD do Azure com fusível, é necessário Olá toocomplete blocos de construção a seguir:
...
3. **[Criar um usuário de teste fusível](#create-a-fuse-test-user)**  -toohave um equivalente do Britta Simon em fusível é vinculado toohello AD do Azure representação do usuário.
...
Nesta seção, habilitar o AD do Azure-logon único no hello portal do Azure e configurar o logon único no aplicativo fusível.

**tooconfigure logon único do AD do Azure com fusível, execute Olá etapas a seguir:**

1. Em Olá portal do Azure, Olá **fusível** página de integração de aplicativos, clique em **o logon único**.
...
3. Em Olá **URLs e unir domínio** , execute Olá etapas a seguir:

    ![Informações de logon único de Domínio e URLs do fusível](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_url.png)
    
    Em Olá **URL de logon** caixa de texto, digite um URL usando o saudação padrão a seguir:`https://<tenant name>.fusion-universal.com/`

    > [!NOTE] 
    > Esse valor não é real. Atualize esse valor com hello URL de logon real. Entre em contato com [equipe de suporte de cliente fusível](mailto:support@fusion-universal.com) tooget esse valor. 
...
6. Em Olá **configuração fusível** seção, clique em **configurar fusível** tooopen **configurar o logon** janela. Saudação de cópia **URL de logout, ID de entidade de SAML e Single Sign-On URL do serviço SAML** de saudação **seção de referência rápida.**

    ![Configuração do Fuse](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_configure.png) 

7. tooget SSO configurado para o seu aplicativo, entre em contato com [a equipe de suporte fusível](mailto:support@fusion-universal.com) e fornecê-los com os seguintes hello:

    * Olá baixado **arquivo de certificado (Raw)**
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Fuse. Trabalhe com [a equipe de suporte fusível](mailto:support@fusion-universal.com) tooadd usuários de saudação na plataforma de fusível hello.


### <a name="assign-hello-azure-ad-test-user"></a>Atribuir um usuário de teste de saudação do AD do Azure

Nesta seção, você pode habilitar Britta Simon toouse logon único do Azure, concedendo acesso tooFuse.

![Atribuir função de usuário Olá][200] 

**tooassign Britta Simon tooFuse, execute Olá etapas a seguir:**

1. No hello portal do Azure, abra a exibição dos aplicativos Olá e navegue toohello exibição de diretório e ir muito**aplicativos empresariais** , em seguida, clique em **todos os aplicativos**.

    ![Atribuir usuário][201] 

2. Na lista de aplicativos hello, selecione **fusível**.
...
Quando você clica em bloco fusível Olá Olá painel de acesso, você deve obter automaticamente assinado em tooyour fusível do aplicativo.
