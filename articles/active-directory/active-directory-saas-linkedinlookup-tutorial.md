...
7. Marque **Mostrar configurações avançadas de URL**, se quiser configurar o aplicativo no modo iniciado em **SP**:
    ...
    > [!NOTE] 
    > Isso não é um valor real. O usuário precisa atualizar esses valores com a URL de Logon real. Contate a [equipe de suporte do Cliente LinkedIn Lookup](https://business.LinkedIn.com/lookup) para obter esse valor.
