...
Neste tutorial, você aprenderá como toointegrate ZIVVER com o Azure Active Directory (AD do Azure).

Integrando ZIVVER com o AD do Azure fornece Olá benefícios a seguir:

- Você pode controlar no AD do Azure que tenha acesso tooZIVVER.
- Você pode habilitar seu usuários tooautomatically get conectado tooZIVVER (logon único) com suas contas do AD do Azure.
...
tooconfigure integração do AD do Azure com ZIVVER, você precisa Olá itens a seguir:

- Uma assinatura do AD do Azure
- Uma assinatura habilitada para logon único do ZIVVER
...
1. Adicionando ZIVVER da Galeria de saudação
2. Configurar e testar o logon único do AD do Azure

## <a name="adding-zivver-from-hello-gallery"></a>Adicionando ZIVVER da Galeria de saudação
integração de saudação tooconfigure de ZIVVER no AD do Azure, você precisa tooadd ZIVVER da lista de tooyour Olá Galeria de aplicativos SaaS gerenciados.

**tooadd ZIVVER da Galeria hello, execute Olá etapas a seguir:**
...
4. Na caixa de pesquisa hello, digite **ZIVVER**, selecione **ZIVVER** no painel de resultados e clique em **adicionar** botão aplicativo hello de tooadd.
...
Nesta seção, você configura e testa o logon único do Azure AD com o ZIVVER baseado em um usuário de teste chamado “Brenda Fernandes”.

Para toowork de logon único, o AD do Azure precisa tooknow que usuário de contraparte Olá em ZIVVER é tooa usuário no AD do Azure. Em outras palavras, uma relação de link entre um usuário do AD do Azure e o usuário relacionado de saudação em ZIVVER precisa toobe estabelecida.

ZIVVER, atribuir valor Olá Olá **nome de usuário** no AD do Azure como valor de saudação do hello **Username** tooestablish relação de link de saudação.

tooconfigure e teste de logon único do AD do Azure com ZIVVER, é necessário Olá toocomplete blocos de construção a seguir:
...
3. **[Criar um usuário de teste ZIVVER](#create-a-zivver-test-user)**  -toohave um equivalente do Britta Simon em ZIVVER é toohello vinculado do Azure AD representação do usuário.
...
Nesta seção, habilitar o AD do Azure-logon único no hello portal do Azure e configurar o logon único no aplicativo ZIVVER.

**tooconfigure AD do Azure-logon único com ZIVVER, execute Olá etapas a seguir:**

1. Em Olá portal do Azure, Olá **ZIVVER** página de integração de aplicativos, clique em **o logon único**.
...
3. Em Olá **ZIVVER domínio e URLs** , execute Olá etapas a seguir:
    ...
    Em Olá **identificador** caixa de texto, digite a URL de saudação:`https://app.zivver.com/SAML/Zivver`
...
6. tooconfigure logon único no **ZIVVER** lado, você precisa toosend Olá baixado **Metadata XML** muito[equipe de suporte do ZIVVER](https://support.zivver.com). Eles definidos Olá de toohave essa configuração conexão SSO do SAML definido corretamente em ambos os lados.
...
### <a name="create-a-zivver-test-user"></a>Criar um usuário de teste do ZIVVER

Nesta seção, você criará uma usuária chamada Brenda Fernandes no ZIVVER. Trabalhar com [ZIVVER equipe de suporte](https://support.zivver.com) tooadd usuários de saudação na plataforma ZIVVER hello.

### <a name="assign-hello-azure-ad-test-user"></a>Atribuir um usuário de teste de saudação do AD do Azure

Nesta seção, você pode habilitar Britta Simon toouse logon único do Azure, concedendo acesso tooZIVVER.

![Atribuir função de usuário Olá][200] 

**tooassign Britta Simon tooZIVVER, execute Olá etapas a seguir:**

1. No hello portal do Azure, abra a exibição dos aplicativos Olá e navegue toohello exibição de diretório e ir muito**aplicativos empresariais** , em seguida, clique em **todos os aplicativos**.

    ![Atribuir usuário][201] 

2. Na lista de aplicativos hello, selecione **ZIVVER**.
...
Quando você clica em Olá ZIVVER bloco no painel de acesso de saudação, você deve obter tooyour automaticamente conectado no aplicativo de ZIVVER.
