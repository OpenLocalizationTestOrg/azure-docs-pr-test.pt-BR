---
title: aaaAzure AD v 2.0 em nome de fluxo de OAuth 2.0 | Microsoft Docs
...
---
# Fluxo em nome de do OAuth 2.0 e Azure Active Directory v2.0
...
| client_secret |obrigatório | segredo do aplicativo Hello gerado para seu aplicativo no hello Portal de registro de aplicativo. |
| asserção |obrigatório | valor Olá Olá token usado na solicitação de saudação. |
| scope |obrigatório | Lista de escopos para solicitação de token Olá separada por espaço. Para obter mais informações, consulte [escopos](active-directory-v2-scopes.md).|
...
#### Exemplo
Olá HTTP POST a seguir solicita um token de acesso com `user.read` escopo Olá https://graph.microsoft.com web API.
...
#### Exemplo
Olá HTTP POST a seguir solicita um token de acesso com `user.read` escopo para Olá https://graph.microsoft.com API da web com um certificado.
...
Hello exemplo a seguir mostra uma solicitação de tooa de resposta de êxito de um token de acesso para API da web de https://graph.microsoft.com hello.
...
* [Concessão de credenciais do cliente do OAuth 2.0 no Azure AD v2.0](active-directory-v2-protocols-oauth-client-creds.md)
* [OAuth 2.0 no Azure AD v2.0](active-directory-v2-protocols-oauth-code.md)
