...
## [Quais são as soluções Olá pré-configurado?](iot-suite-what-are-preconfigured-solutions.md)


# Introdução
## [Introdução ao soluções Olá pré-configurado](iot-suite-getstarted-preconfigured-solutions.md)
...
## [Conecte-se a uma solução de monitoramento remota do toohello aplicativo lógico](iot-suite-logic-apps-tutorial.md)
## [Personalizar uma solução pré-configurada](iot-suite-guidance-on-customizing-preconfigured-solutions.md)
## [Usar a telemetria dinâmica com hello remota de solução de monitoramento](iot-suite-dynamic-telemetry.md)
## [Criar uma regra personalizada na solução de monitoramento remoto Olá](iot-suite-custom-rule.md)
## [Informações do dispositivo no hello remota de solução de monitoramento](iot-suite-remote-monitoring-device-info.md)
...
## [Segurança de saudação de plano de fundo para cima](securing-iot-ground-up.md)
