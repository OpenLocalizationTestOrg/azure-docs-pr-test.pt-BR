...
Você pode usar [modelos do Azure Resource Manager](../azure-resource-manager/resource-group-authoring-templates.md) toocreate e configurar espaços de trabalho de análise de Log. Exemplos de tarefas Olá que podem ser executadas com modelos:
...
Este artigo fornece um modelo de exemplos que ilustram algumas das configuração Olá que você pode executar a partir de modelos.

## <a name="create-and-configure-a-log-analytics-workspace"></a>Criar e configurar um espaço de trabalho do Log Analytics
Olá modelo exemplo a seguir ilustra como:

1. Criar um espaço de trabalho, incluindo a retenção de dados de configuração
2. Adicionar espaço de trabalho de toohello de soluções
3. Criar pesquisas salvas
4. Criar um grupo de computadores
5. Habilitar a coleta de logs do IIS nos computadores com o agente do Windows hello instalado
...
8. Coletar eventos de erro e aviso de saudação Log de eventos do aplicativo de computadores Windows
...
11. Coletar logs do IIS e logs de eventos do Windows gravados pela conta de armazenamento do diagnóstico do Azure tooa
...
```
### <a name="deploying-hello-sample-template"></a>Modelo de implantação de exemplo hello
modelo de exemplo hello toodeploy:

1. Salve o exemplo anexado hello em um arquivo, por exemplo`azuredeploy.json` 
2. Editar saudação toohave Olá configuração de modelo que você deseja
3. Use PowerShell ou hello modelo de Olá toodeploy de linha de comando
...
Galeria de modelos de início rápido do Azure Olá inclui vários modelos para análise de Log, incluindo:

* [Implantar uma máquina virtual executando o Windows hello extensão VM de análise de Log](https://azure.microsoft.com/documentation/templates/201-oms-extension-windows-vm/)
* [Implantar uma máquina virtual executando o Linux com hello extensão VM de análise de Log](https://azure.microsoft.com/documentation/templates/201-oms-extension-ubuntu-vm/)
...
* [Implantar um cluster do Service Fabric e criar um toomonitor de espaço de trabalho de análise de Log-](https://azure.microsoft.com/documentation/templates/service-fabric-vmss-oms/)
