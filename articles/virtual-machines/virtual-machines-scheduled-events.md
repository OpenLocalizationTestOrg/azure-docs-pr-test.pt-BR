...
> [!NOTE] 
> Visualizações são feitas tooyou disponível em condição de saudação concordar toohello termos de uso. Para obter mais informações, consulte [Termos de Uso Complementares do Microsoft Azure para Visualizações do Microsoft Azure](https://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/).
>
...
## <a name="scheduled-events---hello-basics"></a>Eventos agendados - Olá Noções básicas  
...
### <a name="discovering-hello-endpoint"></a>Ponto de extremidade de descoberta Olá
...
Manutenção de máquinas virtuais por meio de saudação portal do Azure, API, CLI, iniciada pelo usuário ou o PowerShell resultará em eventos agendados. Isso permite que você tootest lógica de preparação de manutenção de saudação em seu aplicativo e permite tooprepare seu aplicativo para manutenção iniciada pelo usuário.
...
- Leia mais sobre Olá APIs disponíveis no hello [metadados de serviço da instância](virtual-machines-instancemetadataservice-overview.md).
