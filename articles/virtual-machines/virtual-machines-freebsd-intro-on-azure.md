...
* Se você quiser toobring seu próprios tooAzure FreeBSD, consulte muito[criar e carregar um VHD FreeBSD tooAzure](linux/classic/freebsd-create-upload-vhd.md).
