...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [JSON de máquina Virtual](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L295).
...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [conta de armazenamento](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L109).
...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [associação de máquina Virtual e a conta de armazenamento](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L341).
...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [rede Virtual e sub-redes](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L136).
...
## <a name="network-interface"></a>Interface de rede
 ...
 Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [Interface de rede](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L166).
...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [perfil de rede da máquina Virtual](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L350).
...
Siga este exemplo JSON do link toosee Olá no modelo do Gerenciador de recursos de hello – [Azure SQL DB](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-linux/azuredeploy.json#L401).
