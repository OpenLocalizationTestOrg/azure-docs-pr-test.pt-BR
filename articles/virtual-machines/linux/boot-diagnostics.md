...
---
# <a name="how-toouse-boot-diagnostics-tootroubleshoot-linux-virtual-machines-in-azure"></a>Como toouse inicializar máquinas virtuais do diagnóstico tootroubleshoot Linux no Azure
...
Diagnóstico de inicialização tooenable por meio do portal hello, você também pode atualizar uma máquina virtual existente por meio do portal hello. Selecione Olá opção de diagnóstico de inicialização e salvar. Reinicie o efeito de tootake VM hello.
