...
Este script cria uma Máquina Virtual do Azure com um sistema operacional Ubuntu. Depois de executar o script hello, você pode acessar a máquina virtual de saudação via SSH.
