...
Esse script cria uma máquina Virtual do Azure e usa Olá extensão de Script de personalizado de máquina Virtual do Azure tooinstall NGINX. Depois de executar o script hello, você pode acessar um site de demonstração no endereço IP público de saudação da máquina virtual de saudação.
...
extensão do script personalizado Olá copia o script na máquina virtual de saudação. script Hello é execute tooinstall e configurar um servidor web NGINX. 
...
| [az vm create](https://docs.microsoft.com/cli/azure/vm#create) | Cria a máquina virtual de saudação. Esse comando também especifica Olá toobe de imagem de máquina virtual usada e as credenciais administrativas.  |
...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension#set) | Adiciona e executa uma extensão de máquina virtual tooa VM. Neste exemplo, a extensão de script personalizado de saudação é usado tooinstall NGINX.|
