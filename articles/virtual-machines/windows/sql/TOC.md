...
# Introdução
## [Provisionar uma máquina virtual no portal do Azure de saudação](virtual-machines-windows-portal-sql-server-provision.md)
## [Provisionar uma VM usando o Azure PowerShell](virtual-machines-windows-ps-sql-create.md)
## [Conecte-se tooa VM](virtual-machines-windows-sql-connect.md)
...
## Gerenciar
### [Use Olá extensão do SQL Server IaaS Agent](virtual-machines-windows-sql-server-agent-extension.md)
