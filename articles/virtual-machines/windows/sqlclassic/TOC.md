...
# Introdução
## [Provisionar uma VM em Olá Portal do Azure](../sql/virtual-machines-windows-portal-sql-server-provision.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json)
## [Provisionar uma VM usando o Azure PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
## [Conecte-se tooa VM](virtual-machines-windows-classic-sql-connect.md)
...
### [Configurar o grupo de disponibilidade do AlwaysOn no portal clássico Olá](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
...
### [Estender tooAzure de grupo de disponibilidade local](virtual-machines-windows-classic-sql-onprem-availability.md)
## Gerenciar
### [Use Olá extensão do SQL Server IaaS Agent](virtual-machines-windows-classic-sql-server-agent-extension.md)
...
### [Use o PowerShell toocreate uma VM do Azure com um servidor de relatório](virtual-machines-windows-classic-ps-sql-report.md)
