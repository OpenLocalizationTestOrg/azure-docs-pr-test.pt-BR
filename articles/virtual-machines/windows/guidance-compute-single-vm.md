...
---
# <a name="best-practices-for-running-a-windows-vm-on-azure"></a><span data-ttu-id="7373f-103">Práticas recomendadas para executar uma VM do Windows no Azure</span><span class="sxs-lookup"><span data-stu-id="7373f-103">Best Practices for running a Windows VM on Azure</span></span>
