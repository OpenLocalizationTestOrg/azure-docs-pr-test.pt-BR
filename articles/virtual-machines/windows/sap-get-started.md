...
---
# <a name="using-sap-on-azure-windows-virtual-machines-vms"></a>Usando o SAP em VMs (Máquinas Virtuais) Windows do Azure
...
Escolhendo o Microsoft Azure como seu parceiro de nuvem pronto SAP, você será tooreliably capaz de executar o crítico SAP cargas de trabalho em um scaaleable, compatível e a plataforma corporativa comprovada.  Obter escalabilidade hello, flexibilidade, economia e de custos do Azure. Com hello expandido parceria entre a Microsoft e SAP, você pode executar aplicativos SAP em cenários de desenvolvimento/teste e produção no azure - e totalmente suportados. Do SAP NetWeaver tooSAP S4/HANA Linux tooWindows, tooSQL do SAP HANA, temos suas necessidades. 

Com os serviços de máquina virtual do Microsoft Azure e o SAP HANA em grandes instâncias do Azure, a Microsoft oferece uma plataforma abrangente de IaaS (Infraestrutura como Serviço). Uma vez que há suporte para uma ampla gama de soluções SAP no Azure, este documento de introdução servirá como um Sumário para nosso conjunto atual de documentos SAP. Como mais títulos são adicionados a biblioteca de documentos tooour - você os verá adicionados aqui. 
...
| --- | --- | --- |
| SAP HANA Developer Edition (inclusive o software de cliente do HANA Olá composta de SQLODBC, ODBO-somente para Windows, ODBC, drivers JDBC, HANA studio e o banco de dados do HANA) |Red Hat Enterprise Linux, SUSE Linux Enterprise |A7, A8 |
...
Microsoft Azure é certificado para Olá produtos SAP, com suporte total da Microsoft e SAP a seguir.

| Produto SAP | SO convidado | RDBMS | Tipos de máquina virtual |
| --- | --- | --- | --- |
| Software SAP Business Suite |Windows, SUSE Linux Enterprise, Red Hat Enterprise Linux |SQL Server, Oracle (somente Windows), DB2, SAP ASE |A5 tooA11, D11 tooD14, DS11 tooDS14, GS1 tooGS5 |
| SAP Business All-in-One |Windows, SUSE Linux Enterprise, Red Hat Enterprise Linux |SQL Server, Oracle (somente Windows), DB2, SAP ASE |A5 tooA11, D11 tooD14, DS11 tooDS14, GS1 tooGS5 |
| SAP BusinessObjects BI |Windows |N/D |A5 tooA11, D11 tooD14, DS11 tooDS14, GS1 tooGS5 |
| SAP NetWeaver |Windows, SUSE Linux Enterprise, Red Hat Enterprise Linux |SQL Server, Oracle (somente Windows), DB2, SAP ASE |A5 tooA11, D11 tooD14, DS11 tooDS14, GS1 tooGS5 |
...
Resumo:, Este artigo descreve como toodeploy SAP IDES em execução com o SQL Server e o sistema operacional Windows no Microsoft Azure por meio do SAP nuvem Appliance biblioteca 3.0. 

Atualizado: setembro de 2016

[Esse guia pode ser encontrado aqui](sap-cal-ides-erp6-ehp7-sp3-sql.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

## <a name="3da0389e-708b-4e82-b2a2-e92f132df89c"></a>Planejamento e implementação
título: aaaSAP NetWeaver no Azure máquinas virtuais (VMs) – guia de planejamento e implementação
...
título: aaaSAP NetWeaver no Azure máquinas virtuais (VMs) – guia de implantação
...
título: aaaSAP NetWeaver no Azure máquinas virtuais (VMs) – guia de implantação de DBMS
...
## <a name="63dab028-2c4f-4636-8f99-90bbb264eaba"></a>Guia de implantação de alta disponibilidade
título: aaaSAP NetWeaver no Azure máquinas virtuais (VMs) – guia de implantação de alta disponibilidade

Resumo: Este documento descreve como o ponto único de SAP de componentes de falha como SAP ASCS/SCS do hello e DBMS pode ser protegido no Azure. Componentes de saudação SAP ASCS/SCS, DBMS e aplicativos servidores são essenciais para a funcionalidade de saudação do sistemas SAP NetWeaver, por exemplo, ABAP do SAP NetWeaver, Java do SAP NetWeaver, sistemas SAP NetWeaver ABAP + Java. Portanto, a funcionalidade de alta disponibilidade necessidades toobe colocar em colocar toomake-se de que os componentes possam sustentar uma falha de um servidor ou em uma VM como feito com configurações de Cluster do Windows para ambientes de Hyper-V e bare-metal.

Atualização: dezembro de 2016

[Este guia pode ser encontrado aqui][ha-guide]
