...
Em setembro de 2016, a Microsoft lançou um recurso com o qual é possível gerenciar vários endereços IP virtual usando um [Balanceador de carga interno do Azure][load-balancer-multivip-overview]. Essa funcionalidade já existe no balanceador de carga externo do Azure hello.
...
> [!NOTE]
> Esse recurso está disponível apenas no modelo de implantação do Azure Resource Manager hello.
...
4. [Instalar a instância de banco de dados de saudação][sap-ha-guide-9.2].  
