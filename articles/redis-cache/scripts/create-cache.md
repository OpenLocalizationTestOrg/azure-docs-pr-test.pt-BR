...
Nesse cenário, você aprenderá como toocreate um Cache Redis do Azure.
...
Esse script usa Olá toocreate comandos a seguir, um grupo de recursos e um cache redis. Cada comando na documentação específica do toocommand Olá tabela links.
