...
Este artigo fornece ajuda para solucionar problemas de erros, você pode experimentar com automação Hybrid Runbook Workers e sugere soluções possíveis tooresolve-los.
...
2. Olá hybrid worker de saudação do computador está em execução no possui menos que o mínimo de saudação [requisitos de hardware](automation-offering-get-started.md#hybrid-runbook-worker)  
