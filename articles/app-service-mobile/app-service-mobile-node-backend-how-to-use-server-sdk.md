...
1. Faça logon no [portal do Azure].
2. Na parte superior esquerda da janela, clique no **+ novo** botão > **Web + móvel** > **aplicativo móvel**, em seguida, forneça um nome para seu back-end do aplicativo móvel.
