...
---
# <a name="how-does-hyper-v-replication-tooazure-work-in-site-recovery"></a>Como funciona a tooAzure de replicação do Hyper-V na recuperação de Site?


Este artigo descreve os componentes de saudação e processos envolvidos ao replicar máquinas virtuais de Hyper-V, tooAzure usando Olá local [do Azure Site Recovery](site-recovery-overview.md) serviço.
...
Há vários componentes envolvidos ao replicar tooAzure de VMs Hyper-V.
...
**Figura 2: Replicação tooAzure nuvens do Hyper-V no VMM**
...
**Figura 3: Processo de replicação e a recuperação para tooAzure de replicação do Hyper-V**
