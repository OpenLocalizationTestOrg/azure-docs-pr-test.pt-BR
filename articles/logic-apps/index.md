        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre os Aplicativos Lógicos</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à criação de um novo Aplicativo Lógico conectando serviços SaaS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à criação de um Aplicativo Lógico usando um modelo</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Esquemas</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Linguagem de definição de fluxo de trabalho</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Gatilhos e ações do fluxo de trabalho</a></p>
                   </div>
                </div>
            </div>
        </div>
