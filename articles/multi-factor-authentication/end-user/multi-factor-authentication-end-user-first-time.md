...
Quando o departamento de TI exige que você toostart usando a verificação em duas etapas, você verá uma tela que diz **seu administrador exigiu que você configure essa conta para verificação de segurança adicionais**:
