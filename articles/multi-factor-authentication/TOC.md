...
## [Como tooget Azure MFA](multi-factor-authentication-versions-plans.md)

# Introdução
## [Escolha onde toodeploy](multi-factor-authentication-get-started.md)
## [MFA na nuvem Olá](multi-factor-authentication-get-started-cloud.md)
...
### Implantar MFA local
#### [Instalar o portal do usuário Olá](multi-factor-authentication-get-started-portal.md)
...
#### [Configurar alta disponibilidade](mfa-server-high-availability.md)
