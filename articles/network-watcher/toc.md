...
## Verifique se tooand de fluxos IP de uma VM
...
## [Analisar pacotes capturas toofind anomalias](network-watcher-deep-packet-inspection.md)
## [Use o pacote captura toodo pró-ativo monitoramento de rede com funções do Azure](network-watcher-alert-triggered-packet-capture.md)
