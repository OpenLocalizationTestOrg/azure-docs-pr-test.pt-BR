---
title: "aaaAzure pesquisa documentação - tutoriais, referência de API | Microsoft Docs"
description: "Saiba como tooadd robusto pesquisar recursos, incluindo o monitoramento de atividades, toocustom web ou aplicativos móveis. Referências e outras documentações de API."
services: search
author: carolz
manager: carolz
layout: LandingPage
...
Saiba como a pesquisa de tooadd da web personalizado para tooyour recursos ou aplicativos móveis usando a pesquisa do Azure, um serviço de pesquisa de nuvem gerenciado. Tutoriais, referências de API e outras documentações mostram como tooadd escalonável pesquisa de texto completo em vários idiomas, pesquisa geoespaciais, filtragem e navegação facetada, consultas de preenchimento automático, o realce de ocorrências e analisadores personalizados.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à pesquisa do Azure usando Olá portal do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
