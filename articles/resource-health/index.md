---
title: Integridade de Recursos do Azure - Tutoriais | Microsoft Docs
description: 
...
---
# <a name="azure-resource-health-documentation"></a>Documentação do Azure Resource Health
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre o Azure Resource Health</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre tipos de recursos e verificações de integridade no Resource Health</h3>
                    </div>
                </div>
            </div>
        </div>
