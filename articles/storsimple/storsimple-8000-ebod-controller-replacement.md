...
2. Acesse o dispositivo tooyour e navegue muito**configurações** > **a integridade do Hardware**e verifique se esse status de saudação do hello LED de módulo do controlador EBOD ativo Olá é verde e hello LED para Olá falhado Módulo do controlador EBOD é vermelho.
