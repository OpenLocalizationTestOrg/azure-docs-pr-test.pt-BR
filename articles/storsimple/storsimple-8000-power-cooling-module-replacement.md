...
> [!IMPORTANT]
> Antes de remover e substituir um PCM, revise as informações de segurança de saudação em [substituição de componentes de hardware do StorSimple](storsimple-8000-hardware-component-replacement.md).
...
1. No portal clássico do Azure do hello, clique em **Configurações > Monitor > integridade do Hardware**. Verificar o status de saudação de componentes PCM Olá em **componentes compartilhados** tooidentify qual PCM falhou:
