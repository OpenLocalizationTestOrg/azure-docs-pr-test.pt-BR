...
|:--- |:--- |:--- |:--- |
| Chassi |1 |Não |[Substitua o chassi Olá em seu dispositivo StorSimple](storsimple-chassis-replacement.md) |
...
| Bateria de backup |2 |Sim |[Substituir o módulo de bateria de backup Olá em seu dispositivo StorSimple](storsimple-battery-replacement.md) |
...
Por favor, [entre em contato com o Microsoft Support](storsimple-contact-microsoft-support.md) tooorder qualquer uma dessas unidades de substituição.
