...
O Azure fornece várias soluções para analisar dados de streaming: [Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/) e [Apache Storm no Azure HDInsight](https://azure.microsoft.com/services/hdinsight/apache-storm/). Ambas as plataformas de análise fornecem vantagens de saudação de uma solução de PaaS. Mas plataformas Olá têm algumas diferenças significativas em seus recursos, bem como em como configurar e gerenciá-los. 

Este artigo fornece uma comparação lado a lado de toohelp de recursos, que você pode escolher entre Apache Storm e análise de fluxo do Azure como uma plataforma de análise de nuvem. 
...
O usuários implantam e monitoram um cluster inteiro, que pode hospedar vários trabalhos do Storm, bem como outras cargas de trabalho (inclusive lote).
        ...
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Preço por volume de dados processados e Olá número de unidades de streaming por hora que Olá trabalho está em execução. 
                </p>
            ...
            <td width="246" valign="top">
                <p>
unidade de saudação de compra é baseado em cluster e é cobrada com base na hora de Olá Olá cluster está em execução, independentemente dos trabalhos implantados.
                </p>
                <p>
...
Agregações em janelas e junções temporais têm suporte por padrão.
            ...
            <td width="246" valign="top">
                <p>
Operadores temporais devem ser implementadas por usuário hello.
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Os usuários podem criar, depurar e monitorar trabalhos através do hello portal do Azure, usando dados de exemplo derivados de um fluxo ao vivo.
                </p>
            </td>
            <td width="246" valign="top">
                <p>
Usuários que usam o .NET podem desenvolver, depurar e monitorar por meio do Visual Studio. Usuários usando o Java ou outras linguagens podem usar Olá IDE de sua escolha.
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Logs de status e as operações de trabalho básico são depuração toohelp disponíveis. Análise de fluxo no momento não permitem aos usuários especificar o conteúdo ou a quantidade de conteúdo está incluído nos logs de hello (ou seja, modo detalhado).
                </p>
            </td>
            <td width="246" valign="top">
                <p>
Os logs detalhados estão disponíveis. Os usuários podem acessar os logs no Visual Studio ou fazendo logon no cluster toohello e acessar logs de saudação diretamente.
                </p>
            </td>
        </tr>
        <tr>
...
O monitoramento é implementado usando o Portal do Azure e APIs REST. Usuários também podem configurar alertas do Azure.
            ...
            <td width="246" valign="top">
                <p>
Monitoramento é implementado usando APIs REST e Olá profusão de interface do usuário.
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Escalabilidade é determinada pelo número de saudação de unidades de Streaming (SUs) para cada trabalho. Cada unidade de Streaming processa o too1 MB/segundo, com um máximo de 50 unidades. Para obter mais informações, consulte <a href="https://docs.microsoft.com/azure/stream-analytics/stream-analytics-scale-jobs">taxa de transferência escala tooincrease</a>.
                </p>
            </td>
            <td width="246" valign="top">
                <p>
Escalabilidade é determinada pelo número de saudação de nós no cluster HDInsight profusão de saudação. limite superior Olá número de saudação de nós é definido pela cota do Azure do usuário hello.
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Os usuários podem aumentar o processamento de dados ou otimizar os custos aumentando ou diminuindo o número de saudação de unidades de Streaming, com um limite de 1 GB/segundo.
                </p>
            </td>
            <td width="246" valign="top">
                <p>
...
Aplicação de patch automáticas sem tempo de inatividade.
        ...
        <tr>
            ...
            <td width="246" valign="top">
                <p>
SLA de 99,9% de tempo de atividade do cluster Storm de saudação. 
                </p>
                <p>
O Apache Storm é uma plataforma de streaming tolerante a falhas. No entanto, é tooensure de responsabilidade do usuário Olá que streaming trabalhos são executados sem interrupção.
                </p>
            </td>
        </tr>
    </tbody>
...
Políticas internas configuráveis podem reordenar eventos, soltá-los ou ajustar a hora do evento.
            ...
            <td width="246" valign="top">
                <p>
Os usuários devem implementar lógica toohandle neste cenário.
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Dados de referência estão disponíveis no Armazenamento de Blobs do Azure com um máximo de 100 MB de cache na memória. Dados de referência são atualizados pelo serviço de saudação.
                </p>
            </td>
            <td width="246" valign="top">
                <p>
