...
Gateway de aplicativo do Azure pode ser configurado tooterminate Olá Secure Sockets Layer (SSL) sessão Olá gateway tooavoid cara SSL descriptografia tarefas toohappen no farm de web hello. Descarregamento SSL também simplifica o gerenciamento de certificado no servidor de front-end de saudação.
...
saudação de exemplo a seguir cria um application gateway com descarregamento SSL.  certificado Hello e a senha do certificado devem ser a chave privada válida do tooa atualizado.
