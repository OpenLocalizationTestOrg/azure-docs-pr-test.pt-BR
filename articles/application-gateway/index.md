---
title: "aaaAzure documentação do Gateway do aplicativo - tutoriais, referência de API | Microsoft Docs"
description: "Saiba como toodeploy um controlador de entrega do aplicativo de nuvem. Documentação mostra como tooset até o roteamento de nível de aplicativo e balanceamento de carga para um front-end da web."
...
Saiba como toodeploy Application Gateway, um controlador de entrega de aplicativos (ADC) como um serviço. Tutoriais, referências de API e outras documentações mostram como tooset serviços que permitem a você de balanceamento de carga e roteamento de nível de aplicativo criar um front-end da web escalonáveis e altamente disponível.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Application Gateway usando Olá portal do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
