...
## [Firewall do aplicativo Web](application-gateway-web-application-firewall-overview.md)
### [Regras e conjuntos de regras de núcleo](application-gateway-crs-rulegroups-rules.md)
...
## [Final tooend SSL](application-gateway-backend-ssl.md)
## [Política SSL](application-gateway-ssl-policy-overview.md)
## [Redirecionamento](application-gateway-redirect-overview.md)
## [Suporte multilocatário](application-gateway-web-app-overview.md)
...
#### [CLI 1.0 do Azure](application-gateway-create-gateway-cli-nodejs.md)
