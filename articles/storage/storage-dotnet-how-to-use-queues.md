...
* Exiba toolearn de guias de recurso mais sobre opções adicionais para armazenar dados no Azure.
  * [Introdução ao armazenamento de tabela do Azure usando o .NET](storage-dotnet-how-to-use-tables.md) toostore estruturado de dados.
  * [Introdução ao armazenamento de BLOBs do Azure usando o .NET](storage-dotnet-how-to-use-blobs.md) toostore dados não estruturados.
