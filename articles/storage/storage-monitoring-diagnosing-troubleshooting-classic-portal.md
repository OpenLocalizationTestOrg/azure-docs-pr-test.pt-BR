...
No portal clássico do Azure, na página do **Monitor** da sua conta de armazenamento, você pode adicionar as regras de alertas para notificá-lo se a **Disponibilidade** de um serviço está abaixo dos limites que você especificou.
...
No portal clássico do Azure, na página do **Monitor** da sua conta de armazenamento, você pode adicionar as regras de alertas para notificá-lo se quaisquer métricas de desempenho desse serviço estão abaixo dos limites que você especificou.
...
A figura abaixo da ferramenta de monitoramento do Portal Clássico do Azure mostra um exemplo em que **AverageE2ELatency** é significantemente mais alta que **AverageServerLatency**.
...
Para saber mais sobre o uso do Wireshark para a solução de problemas de rede, consulte o "[Apêndice 2: Usando o Wireshark para capturar o tráfego de rede]".
...
> [!NOTE]
> Para saber mais sobre como usar o Wireshark, veja o <a href="http://www.wireshark.org/docs/wsug_html_chunked/" target="_blank">Guia de Usuários do Wireshark</a>.
> 
> 
...
Para saber mais sobre o rastreamento de **Web Proxy** do Microsoft Message Analyzer, consulte <a href="http://technet.microsoft.com/library/jj674814.aspx" target="_blank">Provedor PEF-WebProxy no TechNet</a>.
