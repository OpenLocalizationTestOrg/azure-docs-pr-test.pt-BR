...
### [Anexar um disco gerenciado de tooa VM do Windows usando o PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [Acesso anônimo tooblobs](storage-manage-access-to-resources.md)
...
### [Migrar máquinas virtuais do Azure tooAzure gerenciados discos](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrar de outras plataformas e AWS tooManaged discos](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migrando tooPremium armazenamento usando o Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Migrar tooPremium armazenamento](storage-migration-to-premium-storage.md)
...
### [Use Olá emulador de armazenamento](storage-use-emulator.md)
...
### [Mover dados tooand do armazenamento](storage-moving-data.md)
### [AzCopy no Windows](storage-use-azcopy.md)
### [AzCopy no Linux](storage-use-azcopy-linux.md)
### [Usando o serviço de importação/exportação Olá](storage-import-export-service.md)
### [Usando a ferramenta de importação/exportação de saudação](storage-import-export-tool-how-to.md)
#### [Configurando Olá, ferramenta de importação/exportação](storage-import-export-tool-setup.md)
...
#### [Olá, ferramenta de importação/exportação de solução de problemas](storage-import-export-tool-troubleshooting-v1.md)
...
### [Usando Olá, ferramenta de importação/exportação (v1)](storage-import-export-tool-how-to-v1.md)
#### [Configurando Olá, ferramenta de importação/exportação](storage-import-export-tool-setup-v1.md)
...
#### [Formato de arquivo de propriedades e metadados do serviço de Importação/Exportação](storage-import-export-file-format-metadata-and-properties.md)
#### [Formato de arquivo do log de serviço de Importação/Exportação](storage-import-export-file-format-log.md)
### [Usando a API REST do serviço de importação/exportação do Azure Olá](storage-import-export-using-the-rest-api.md)
