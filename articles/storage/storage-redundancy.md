...
> [!NOTE]
> Armazenamento de Arquivos do Azure oferece suporte a armazenamento apenas localmente redundante (LRS) e georedundant GRS (armazenamento). Para saber mais sobre o Armazenamento de Arquivos do Azure, veja [Visão geral de Armazenamento de Arquivos do Azure](storage-files-introduction.md).
>
