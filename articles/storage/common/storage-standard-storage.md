...
[**Os discos do Azure gerenciados**](../../virtual-machines/windows/managed-disks-overview.md): esse recurso gerencia contas de armazenamento Olá usadas para discos de VM Olá para você. Especificar o tipo de saudação (Premium ou padrão) e o tamanho do disco é necessário e Azure cria e gerencia disco Olá para você. Você não tem tooworry sobre onde colocar os discos de saudação entre várias contas de armazenamento em ordem tooensure que permanecer dentro dos limites de escalabilidade Olá Olá para contas de armazenamento - Azure lida com isso para você.
...
* [Criar uma VM do Linux usando Olá 2.0 do CLI do Azure](../../virtual-machines/windows/quick-create-cli.md)
