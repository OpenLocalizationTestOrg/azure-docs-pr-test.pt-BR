...
Você pode escolher quais métricas de hora você deseja toodisplay em Olá [portal do Azure](https://portal.azure.com) e configure as regras que notificar os administradores por email sempre que uma métrica de hora em hora excede um limite específico. Para obter mais informações, confira [Receber notificações de alerta](/azure/monitoring-and-diagnostics/monitoring-overview-alerts.md). 
