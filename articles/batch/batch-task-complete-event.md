...
# <a name="task-complete-event"></a>Evento de conclusão de tarefa
 ...
 Esse evento é emitido quando uma tarefa é concluída, independentemente do código de saída de hello. Esse evento pode ser usado toodetermine Olá duração de uma tarefa, em que a tarefa de saudação foi executada e se ele foi repetido.


 Olá, exemplo a seguir mostra Olá corpo de um evento de conclusão de tarefa.
