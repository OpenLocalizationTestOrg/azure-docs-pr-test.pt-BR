<span data-ttu-id="2973a-101">A **[Galeria Cortana Intelligence](http://gallery.cortanaintelligence.com)** é um site criado pela comunidade para descobrir e compartilhar as soluções criadas com o Cortana Intelligence Suite.</span><span class="sxs-lookup"><span data-stu-id="2973a-101">**[Cortana Intelligence Gallery](http://gallery.cortanaintelligence.com)** is a community-driven site for discovering and sharing solutions built with Cortana Intelligence Suite.</span></span>
<span data-ttu-id="2973a-102">Olá galeria tem uma variedade de recursos que você pode usar toodevelop suas próprias soluções de análise.</span><span class="sxs-lookup"><span data-stu-id="2973a-102">hello Gallery has a variety of resources that you can use toodevelop your own analytics solutions.</span></span>
