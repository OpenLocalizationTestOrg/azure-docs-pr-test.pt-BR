## <a name="net-sample-code-repositories"></a>Repositórios de código de exemplo do .NET

Aqui está uma lista de todos os nossos repositórios de exemplo para a biblioteca de cliente .NET de armazenamento do Azure hello.
