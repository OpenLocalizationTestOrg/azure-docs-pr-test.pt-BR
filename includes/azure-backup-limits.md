Olá limites a seguir se aplicam a tooAzure Backup.
...
| Discos de dados anexados tooan máquina virtual do Azure para backup |16 |

* <sup>1</sup>Olá 54400 GB não se aplica tooIaaS backup de VM.
