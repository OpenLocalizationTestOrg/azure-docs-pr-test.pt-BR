...
- Escolha **InvokeMethod**. Olá LED conectado toohello que framboesa Pi pisca várias vezes. aplicativo Olá Olá framboesa Pi envia um painel de solução de backup toohello confirmação:
