...
3. Na caixa de pesquisa de saudação do hello catálogo do Microsoft Update, insira o número de Base de dados de Conhecimento (KB) de saudação de saudação hotfix que você deseja toodownload, por exemplo **3121901**e, em seguida, clique em **pesquisa**.
   
    Olá hotfix listagem aparece, por exemplo, **cumulativa 2.0 de atualização de pacote de Software para StorSimple 8000 Series**.
...
5. Procure os hotfixes adicionais listadas na tabela de saudação acima (**3121900**, **3080728**, **3090322**, e **3121899**) e adicionar cada carrinho de saudação.
...
6. Depois que o software de saudação a atualização é concluída, repita as etapas 3 a 5 tooinstall e monitorar o hello SaaS agente e agente de MDS. Certifique-se de que `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` seja instalado antes de `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Verificar se as versões de software do sistema hello. Tipo:
...
8. Repita as etapas 3 a 5 tooinstall Olá restantes hotfixes do modo normal.
   
   * Olá driver LSI - KB3121900
