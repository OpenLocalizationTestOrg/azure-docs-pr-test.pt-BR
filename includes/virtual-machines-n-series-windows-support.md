...
> [!NOTE]
> Os links de download do driver Tesla são atuais no momento da publicação. Para os drivers mais recentes do hello, visite Olá [NVIDIA](http://www.nvidia.com/) site.
>